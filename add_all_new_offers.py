#!/usr/bin/env python3
"""
Add all 60 new offers from new_offers.json to scraper.py
before the closing bracket in get_manual_offers() function
"""

import json
import re

# First, let me get the complete new_offers.json from the user's message
# I'll use the full content from the file_content provided
new_offers_json = """[
  {
    "store": "First Direct",
